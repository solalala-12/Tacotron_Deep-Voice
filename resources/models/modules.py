...
def cbhg(inputs, input_lengths, is_training, 
    ...
    with tf.variable_scope(scope):
        with tf.variable_scope('conv_bank'):
            ...
            # bank_channel_size = 128 , prenet output과 같음
            # default stride = 1
            # 1~16까지 conv1d 후 concat
        ...
        # Bidirectional RNN
        # default encoder_rnn_init_state
