...
class AttentionWrapper(RNNCell):
    ...
    def __init__(self,
                 cell,
                 attention_mechanism,
                 is_manual_attention,   # tf 1.13.1
                 manual_alignments,     # tf 1.13.1
...
def _compute_attention(attention_mechanism, cell_output, previous_alignments,attention_layer, is_manual_attention, manual_alignments, time):
    ...
    alignments = tf.cond(is_manual_attention, lambda: manual_alignments[:, time, :],lambda: computed_alignments,)    #  tf 1.13.1
