...
alignment_json = './datasets/son_own/alignment.json'
data_split_log= './datasets/son_total/data_split.log'
for i in os.listdir(parents_dir):
    ...
    for j in tqdm(each_folders):
        ...
        for idx, z in enumerate(each_split_files):
            ...
            json_wav_path=(os.path.join(each_file_path,z))
            shutil.copy(json_wav_path,'./datasets/son_own/audio/')
            al_json['./datasets/son_own/audio/'+z]=text_json
